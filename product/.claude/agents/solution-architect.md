...
- **AID**: `T1-SA-R{N}` (Tier 1, Solution Architect, Round N)
...
`docs/demiurge/architect-orchestration/{review-id}/artifacts/T1-SA-R{N}-full-report.md`에 저장.
상세 분석, ADR, System Design Document, 다이어그램 등을 포함합니다.
