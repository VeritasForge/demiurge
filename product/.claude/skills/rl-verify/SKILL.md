...
결과 폴더: `{dir}/verify-{slug}/`
산출물: `{dir}/verify-{slug}/plan.md`, `{dir}/verify-{slug}/report.md`

### 0-2. 기존 산출물 감지

`{dir}/verify-{slug}/plan.md`가 존재하는지 감지합니다.
...
기존 폴더 존재?
  ...
  └─ YES
       ...
       └─ --force 옵션 없음
            → 사용자에게 질문:
              "이전 검증 결과가 있습니다. ({dir}/verify-{slug}/)"
...
### 산출물 1: `{dir}/verify-{slug}/report.md` — 빈 리포트 초기화
...
### 산출물 2: `{dir}/verify-{slug}/plan.md` — 상세 플랜
