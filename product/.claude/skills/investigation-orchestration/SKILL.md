...
```
docs/demiurge/investigation-orchestration/{investigation-id}/
...
0-5. investigation-plan.md 저장
  docs/demiurge/investigation-orchestration/{investigation-id}/investigation-plan.md 파일 생성:
  - investigation-id
  - 원본 쿼리
  - 핵심 질문 목록
...
1-3. 결과 수집 및 저장
  ...
  - Layer 3: docs/demiurge/investigation-orchestration/{id}/artifacts/{IID}-report.md 파일로 저장
...
2-2. 분류 결과 저장
  docs/demiurge/investigation-orchestration/{id}/cross-verification-r2.md 파일 생성
...
3-4. 결과 저장
  docs/demiurge/investigation-orchestration/{id}/counter-review-r3.md 파일 생성
...
4-4. Investigation Report 생성
  ...
  docs/demiurge/investigation-orchestration/{id}/final-report.md 파일 생성:
...
5-2. Execution Log 기록
  ...
  docs/demiurge/investigation-orchestration/{id}/execution-log.md 파일 생성:
