...
Full Report는 `docs/demiurge/architect-orchestration/{review-id}/artifacts/{AID}-full-report.md`에 저장합니다.
...
```
docs/demiurge/architect-orchestration/
├── {review-id}/
...
```
docs/demiurge/architect-orchestration/{review-id}/
├── research/
...
research_context:
  ...
  relevant_to:
    ...
    data: "[데이터 관련 1줄 요약]"
  full_report: "docs/demiurge/architect-orchestration/{review-id}/research/"
```
...
1. **Phase 1 전체 결과** → `docs/demiurge/architect-orchestration/{review-id}/research/phase1-broad-findings.md`에 Write
2. **Phase 2 심화 결과** (실행 시) → `docs/demiurge/architect-orchestration/{review-id}/research/phase2-deep-dive.md`에 Write
3. **요약본 생성** → `docs/demiurge/architect-orchestration/{review-id}/research/research-summary.md`에 Write
...
이 문서를 `docs/demiurge/architect-orchestration/{review-id}/draft-architecture.md`에 **Write tool**로 저장합니다.
...
Task(
  ...
  ## Draft Architecture
  [docs/demiurge/architect-orchestration/{review-id}/draft-architecture.md 내용 삽입]
...
3. 각 아키텍트의 **Layer 3 (Full Report)** 를 `docs/demiurge/architect-orchestration/{review-id}/artifacts/{AID}-full-report.md`에 **Write tool**로 저장
...
이 문서를 `docs/demiurge/architect-orchestration/{review-id}/consolidated-findings-r{N}.md`에 저장합니다.
...
## Artifacts
- Draft Architecture: `docs/demiurge/architect-orchestration/{review-id}/draft-architecture.md`
- Consolidated Findings: `docs/demiurge/architect-orchestration/{review-id}/consolidated-findings-r{N}.md`
- Full Reports: `docs/demiurge/architect-orchestration/{review-id}/artifacts/`
```

이 문서를 `docs/demiurge/architect-orchestration/{review-id}/final-review.md`에 **Write tool**로 저장합니다.
...
검증 결과를 `docs/demiurge/architect-orchestration/{review-id}/execution-log.md`에 기록:
